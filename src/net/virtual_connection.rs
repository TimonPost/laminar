...
impl VirtualConnection {
    ...
    pub fn new(addr: SocketAddr, config: &Config, time: Instant, state_manager: Box<dyn ConnectionManager>) -> VirtualConnection {
        VirtualConnection {
            ...
            conn_manager_packets: Default::default()
        }
    }
    ...
    /// This will return all packets that are generated by connection manager
    pub fn get_connection_manager_packets(&mut self, time: Instant) -> Result<Vec<Outgoing<'_>>> {
        // TODO implement
        Ok(vec!{})
        // Ok(self.conn_manager_packets
        //     .into_iter()                
        //     .map(|packet| {
        //         match self.process_outgoing_impl(
        //                 packet.payload(),packet.delivery_guarantee(),
        //                     packet.order_guarantee(),None,time) {
        //             Ok(out) => Some(out),
        //             Err(err) => {
        //                 None
        //             }
    ...
    fn reset_connection(&mut self) {
        ...
        self.conn_manager_packets.clear();
    }
