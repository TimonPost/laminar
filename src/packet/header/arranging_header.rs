...
impl ArrangingHeader {
    ...
    pub fn new(arranging_id: u16, stream_id: u8) -> Self {
        ArrangingHeader {
            arranging_id,
            stream_id,
        }
...
mod tests {
    ...
    #[test]
    fn size() {
        let header = ArrangingHeader::new(0, 0);
        assert_eq!(header.size(), ARRANGING_PACKET_HEADER);
    }
}
